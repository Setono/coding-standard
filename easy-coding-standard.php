...
return static function (ContainerConfigurator $containerConfigurator): void {
    ...
    $services->set('PhpCsFixer\Fixer\Comment\SingleLineCommentStyleFixer')
    ...
    $services->set('PhpCsFixer\Fixer\Phpdoc\NoSuperfluousPhpdocTagsFixer')
    ...
    $services->set('PhpCsFixer\Fixer\Whitespace\NoExtraBlankLinesFixer')
